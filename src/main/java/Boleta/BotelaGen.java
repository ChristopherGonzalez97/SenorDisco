 ...
 * @author pc
 */
@WebServlet(name = "BotelaGen", urlPatterns = {"/BotelaGen"})
public class BotelaGen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String d= request.getParameter("dataImg");
            String id= request.getParameter("id");
            HttpSession s = request.getSession();
            s.setAttribute("img", d);
            StringUtils.removeStart(d,"data:image/pgn;base64");
