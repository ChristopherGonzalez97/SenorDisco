...
public class BoletaPK implements Serializable {
    ...
    public BoletaPK(int documentoTributarioIddocumentoTributario, int documentoTributarioVentaIdventa, int documentoTributarioVentaUsuarioIdusuario) {
    ...
    public String toString() {
        return "Clases.BoletaPK[ documentoTributarioIddocumentoTributario=" + documentoTributarioIddocumentoTributario + ", documentoTributarioVentaIdventa=" + documentoTributarioVentaIdventa + ", documentoTributarioVentaUsuarioIdusuario=" + documentoTributarioVentaUsuarioIdusuario + " ]";
    }
