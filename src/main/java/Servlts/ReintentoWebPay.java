 ...
 * @author pc
 */
@WebServlet(name = "ReintentoWebPay", urlPatterns = {"/ReintentoWebPay"})
public class ReintentoWebPay extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReintentoWebPay.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
