...
public class AgregarFamilia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int id =em.createNamedQuery("FamiliaProducto.findAll").getResultList().size()+1; 
            String nombre=request.getParameter("txtFamilia");
            
            FamiliaProducto familia = new FamiliaProducto();
            familia.setIdfamiliaProducto(id);
            ...
            s.setAttribute("MensajePagina", "Familia de productos agregada correctamente <br> redireccionando...");
