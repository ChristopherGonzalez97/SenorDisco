 ...
 * @author pc
 */
@WebServlet(name = "QuitarAgendamiento", urlPatterns = {"/QuitarAgendamiento"})
public class QuitarAgendamiento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DetallePedido flag = new DetallePedido();
            for(DetallePedido d:pedido)
            {
                if(d.getProducto().getIdproducto()==ids)
                {
                    flag = d;
                }
            }
