 ...
 * @author chris
 */
@WebServlet(name = "DeshabilitarProducto", urlPatterns = {"/DeshabilitarProducto"})
public class DeshabilitarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Producto base=em.find(Producto.class, Integer.parseInt(id));
            base.setDisponible(Short.parseShort("0"));
            
            em.getTransaction().begin();
            em.merge(base);
            em.getTransaction().commit();
            HttpSession s=request.getSession();
            s.setAttribute("MensajePagina", "Producto deshabilitado...");
