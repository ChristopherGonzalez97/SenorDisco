 ...
 * @author pc
 */
@WebServlet(name = "InsertarBoleta", urlPatterns = {"/InsertarBoleta"})
public class InsertarBoleta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            byte[] bytes = Boleta.BoletaGenerator.ObtenerBoleta(id);
