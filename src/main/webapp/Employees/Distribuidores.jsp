<%-- 
    ...
    Created on : 19-01-2021, 19:43:15
    Author     : pc
--%>
      ...
      <section class="Verp-roducto">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            ...
            <div class="contact-list-grid">
                <button type="submit" onclick="location.href='RegistrarDistribuidor.jsp'" class="btn btn-block  sent-butnn">Agregar nuevo distribuidor</button>
            </div>
            <div class="contact-list-grid">
                <button type="submit" onclick="location.href='VerDistribuidores.jsp'" class="btn btn-block sent-butnn">Ver distribuidores</button>
            </div>
         </div>
         <!--//contact-map -->
      </section> 
