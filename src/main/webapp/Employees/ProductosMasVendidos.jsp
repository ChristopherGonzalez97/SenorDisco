<%-- 
    ...
    Created on : 24-01-2021, 14:55:33
    Author     : pc
--%>
      ...
      <link href="//fonts.googleapis.com/css?family=Open+Sans:400,600,700" rel="stylesheet">
        <%
            ...
            if(s.getAttribute("filtroMasVendido")!=null)
            {
                ...
                s.removeAttribute("filtroMasVendido");
            }
            else
            {
                 masVendidas = Estadisticas.MasVendidos(); 
            }
    ...
    function ValidarCategoria()
    {
        ...
        <section class="Verp-roducto">
            ...
            <div style="margin: 3vw;">
                ...
                <form action="../VendidoMasFecha" onsubmit="return ValidarFechaDesde()" method="POST" name="FormDesde"  id="fechaAFecha" style="display: none">
                <table>
                    <tr>
                        <td>
                            Fecha desde
                ...
                <form action="../VendidosMasCategoria" onsubmit="return ValidarCategoria()" method="POST" name="FormCategoria" id="categoria" style="display: none" >
                <table>
                    <tr>
                        <td>
