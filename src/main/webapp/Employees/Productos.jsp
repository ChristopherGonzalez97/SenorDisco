<%-- 
    ...
    Created on : 23-10-2020, 12:24:01
    Author     : chris
--%>
...
<html>
    ...
    <script>
      ...
      <body>
        ...
        <section class="p-roducto" style="    padding-top: 5em;">
         <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
             ...
             <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3" style="display: inline-block;margin-left: 28%;">Productos</h3>
            <div class="row">   
                   ...
                   <div>
                       <button style="width: 100%;margin-bottom:1vw;" class="btn-info" onclick="javascript:location.reload(true)">
                          ...
                          <button onclick="location.href='AgregarProducto.jsp'" class="btn-info" style="width: 50%;display: inline-block">
                           ...
                           <button onclick="location.href='VerDeshabilitado.jsp'" class="btn-info" style="width: 48%;display: inline-block">
               ...
               <div class="left-ads-display col-lg-9">
                  <div class="row">
                    <%
                        ...
                        {
                            if(pro.getDisponible()==Short.parseShort("1"))
                            {
                                %>
                                                   ...
                                                   <div class="product_price">
                                                      ...
                                                      <div>
                                                          <button onclick="location.href='AdministrarImagenes.jsp?id=<%=pro.getIdproducto()%>'" class="btn-info" style="width: 50%;display: inline-block">
                                                           ...
                                                           <button class="btn-danger" onclick="location.href='../DeshabilitarProducto?id=<%=pro.getIdproducto()%>'" style="width: 48%;display: inline-block">
