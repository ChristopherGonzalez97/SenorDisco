<%-- 
    Document   : DatosDistribuidor
    Created on : 20-01-2021, 12:45:08
    Author     : pc
--%>
     ...
     <script>
      ...
      <link href="//fonts.googleapis.com/css?family=Open+Sans:400,600,700" rel="stylesheet">
        ...
        <%
            ...
            {
                if(dis.getClienteRutCliente().equals(id))
                {
                    distribuidor=dis;
                }
            }
       ...
       <div class="header-outs" id="home" >
        ...
        <section class="Verp-roducto">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Modulo de Distribuidores</h3>
            <div class="contact-list-grid">
                <button type="submit" onclick="location.href='RegistrarDistribuidor.jsp'" class="btn btn-block  sent-butnn">Ver compras del distribuidor</button>
            </div>
            <div class="contact-list-grid">
                <button type="submit" onclick="location.href='../DeshabilitarDistribuidor?id=<%=distribuidor.getClienteRutCliente() %>'" class="btn btn-block sent-butnn">Deshabilitar distribuidor</button>
            </div>
         </div>
         <!--//contact-map -->
      </section> 
