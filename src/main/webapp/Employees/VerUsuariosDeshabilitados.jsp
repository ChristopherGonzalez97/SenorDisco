<%-- 
    Document   : VerUsuariosDeshabilitados
    Created on : 25-01-2021, 12:20:10
    Author     : pc
--%>
    ...
    <body>
        ...
        <section class="banner-bottom Verp-roducto">
         <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Usuarios deshabilitados</h3>
            <div class="contact-list-grid">
                <button type="button" onclick="location.href='Usuarios.jsp'" class="btn btn-block  sent-butnn">Ver Usuarios</button>
            </div>
            <%
               ...
               <div class="left-ads-display col-lg-12">  
                   <div class="row">
                    <%
                        ...
                        {if(user.getHabilitado()==Short.parseShort("0")){
                            %>
                              ...
                              <div class="men-thumb-item">
                                 ...
                                 <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="../HabilitarUsuario?id=<% out.println(user.getIdusuario()); %>" class="link-product-add-cart">Habilitar</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="item-info-product">
                                  <div class="info-contact-agile">
                                      Nombre:<% out.println(user.getCorreo());%>
                                  </div>
                                  <div class="info-contact-agile">
