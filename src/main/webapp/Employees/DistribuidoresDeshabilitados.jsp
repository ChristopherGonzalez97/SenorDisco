<%-- 
    Document   : DistribuidoresDeshabilitados
    Created on : 20-01-2021, 13:45:41
    Author     : pc
--%>
...
<html>
    <head>
        ...
        <title>Distribuidores deshabilitados</title>
               ...
               <div class="left-ads-display col-lg-12">  
                   <div class="row">
                    <%
                        ...
                        {if(dis.getCliente().getUsuarioIdusuario().getHabilitado()==Short.parseShort("0")){
                            %>
                              ...
                              <div class="men-thumb-item">
                                 ...
                                 <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                       <a href="../HabilitarDistribuidor?id=<% out.println(dis.getClienteRutCliente()); %>" class="link-product-add-cart">Habilitar</a>
                                    </div>
                                 </div>
                              </div>
