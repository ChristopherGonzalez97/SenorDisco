<%-- 
    ...
    Created on : 14-01-2021, 15:49:00
    Author     : pc
--%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function Validar()
        {
            ...
            var email = document.forms["FormularioCliente"]["txtCorreo"].value;
            ...
            if(email==0)
            {
                document.forms["FormularioCliente"]["txtCorreo"].style.borderColor = "red";
    ...
    <body>
        <div class="header-outs" id="home" style="padding-bottom: 12vw;">
         ...
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Inicio de sesion</h3>
            <div class="contact-list-grid">
                <form class="register-form" action="../IniciarSesion" onsubmit="return Validar()" name="FormularioCliente" method="Post">
                        <div class=" agile-wls-contact-mid">
                            <div class="form-group contact-forms">
                                <input type="email" name="txtCorreo" class="form-control"  placeholder="Correo electronico">
                            </div>
                            <div class="form-group contact-forms">
                                <input type="password" name="txtPass"   class="form-control"  placeholder="Contraseña">
                            </div>
                            <div class="g-recaptcha" data-sitekey="6LeVfbMaAAAAAORJ7Zqzh3FypKqM-FRw4mHGH9BA" data-callback="enableBtn"></div>
                            <%
                               ...
                               <% }
                            %>
                            <button type="submit" id="Enviar" class="btn btn-block sent-butnn" disabled="true">Ingresar</button>
                        </div>
                </form>       
            </div>
         </div>
