<%-- 
    Document   : Error404
    Created on : 31-01-2021, 18:10:14
    Author     : pc
--%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        {
            setTimeout(() => {document.getElementById("message2").style.display="block";},15000);
        }
    </script>
    <body class="FondoError" onload="showMessage()">
        ...
        <div>
            <p class="perror2">Error 404</p>
            <p class="perror">Pagina no encontrada</p>
        </div>
        <img class="forbiden3" id="message2" src="../Imagenes/error404.gif" alt=""/>
    </body>
</html>
